...
[Topic(Topic = "chandelier")]
public class ChandelierTopic : ITopic
{
    ITelegramBotClient _client;
    IStatService _statService;
    ILogService _logService;

    public ChandelierTopic(IBotService botService, IStatService statService, ILogService logService)
    {
